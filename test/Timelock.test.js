...
contract('Timelock', ([alice, bob, carol, dev, minter]) => {
    beforeEach(async () => {
        this.cake = await NanoXp.new({ from: alice });
    ...
    it('should also work with MasterGamer', async () => {
        ...
        this.chef = await MasterGamer.new(this.cake.address, this.syrup.address, dev, '1000', '0', { from: alice });
